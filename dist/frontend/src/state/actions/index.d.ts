...
export declare type Action = LoginRequestAction | LoginSuccessAction | LoginFailAction | LogoutAction | RegisterRequestAction | RegisterSuccessAction | RegisterFailAction | UserDetailsRequestAction | UserDetailsSuccessAction | UserDetailsFailAction | UserUpdateRequestAction | UserUpdateSuccessAction | UserUpdateFailAction | UserUpdateResetAction | QuestionsFetchRequestAction | QuestionsFetchSuccessAction | QuestionsFetchFailAction | SubmissionFetchRequestAction | SubmissionFetchSuccessAction | SubmissionFetchFailAction | SubmissionFetchResetAction | SubmissionFetchFlagResetAction | SubmissionCreateRequestAction | SubmissionCreateSuccessAction | SubmissionCreateFailAction | EmailFetchRequestAction | EmailFetchSuccessAction | EmailFetchFailAction | EmailCreateRequestAction | EmailCreateSuccessAction | EmailCreateFailAction;
